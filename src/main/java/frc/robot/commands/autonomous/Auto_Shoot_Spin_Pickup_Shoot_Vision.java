...
public class Auto_Shoot_Spin_Pickup_Shoot_Vision extends SequentialCommandGroup  {
    ...
    public Auto_Shoot_Spin_Pickup_Shoot_Vision(Shooter shooter, Injector injector, Drivetrain drivetrain, LEDController ledController, Intake intake, LimeLightController lc) {
        ...
        addCommands(
            ...
            new ParallelCommandGroup(
                new DT_Auto_Cargo_Align(drivetrain, 0.2, 4),
            ...
            // Drive forward for 0.45 seconds
            new ParallelCommandGroup(
                new DT_DriveVectorTime(drivetrain,0, 0, 0.2, 3),
