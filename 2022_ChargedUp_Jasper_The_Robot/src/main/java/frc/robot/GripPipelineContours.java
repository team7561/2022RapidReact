...
public class GripPipelineContours implements VisionPipeline {

	//Outputs
	private Mat hsvThresholdOutput = new Mat();
	private ArrayList<MatOfPoint> findContoursOutput = new ArrayList<MatOfPoint>();
	private ArrayList<MatOfPoint> filterContoursOutput = new ArrayList<MatOfPoint>();
	public boolean redCargo;
	...
	@Override	public void process(Mat source0) {
		...
		double[] hsvThresholdHue = {103, 110};
		double[] hsvThresholdSaturation = {180, 255};
		double[] hsvThresholdValue = {46, 210};
		if (redCargo)
		{
	...
	private void filterContours(List<MatOfPoint> inputContours, double minArea,
		...
		maxHeight, double[] solidity, double minRatio, double maxRatio, List<MatOfPoint> output) {
